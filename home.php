        ...
        <div class="container">
            <div class="row">
                <div class="col col-sm-4 mb-3">
                    <div>
                        <a href=""><img class="w-100 zoom-img" src="pictures/1-3.jpg" alt="" ></a>
                    </div>
                </div>
                <div class="col-xs-12 col-sm-4 mb-3">
                    <div>
                        <a href=""><img class="w-100 zoom-img" src="pictures/2-3.jpg" alt=""></a>
                    </div>
                </div>
                <div class="col col-sm-4 mb-3">
                    <div>
                        <a href=""><img class="w-100 zoom-img" src="pictures/3-3.jpg" alt=""></a>
                    </div>
                </div>
