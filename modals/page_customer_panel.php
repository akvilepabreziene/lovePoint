                        ...
                        <div class="input-group">
                            ...
                            <div class="input-group-prepend show-password">
                                <span class="input-group-text" id="inputGroup-sizing-default">
                                    <div class="eye-show">
                                        <svg width="18" height="18" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="eye-slash" class="svg-inline--fa fa-eye-slash fa-w-20" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512">
                                    ...
                                    <div class="eye-hide">
                                        <svg width="18" height="18" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="eye" class="svg-inline--fa fa-eye fa-w-18" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512">
